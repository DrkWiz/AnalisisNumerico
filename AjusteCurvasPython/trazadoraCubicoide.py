...
def calculate_spline_polynomial(points):
    ...
    # Calcula los coeficientes c, b, y d del polinomio utilizando los valores intermedios y las diferencias en los valores de y y x entre puntos consecutivos.
    l[n] = 1.0
    z[n] = 0.0
    c[n] = 0.0
...
coefficients = calculate_spline_polynomial(points)
